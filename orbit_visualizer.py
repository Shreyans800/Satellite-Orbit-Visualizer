...
# Inject CSS to hide sidebar toggle and force sidebar open always
st.markdown("""
    <style>
...
orbit_table = pd.DataFrame({
    ...
    "Periapsis (km)": [160, 2000, 35786, 35786, 600, "Varies, approx 90°", 200, "-"],
    "Apoapsis (km)": [2000, 35786, "100000", 35786, 800, "Varies, approx 90°", 35786, "-"],
})
